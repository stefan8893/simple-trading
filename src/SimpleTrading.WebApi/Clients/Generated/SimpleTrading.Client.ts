...
export interface ISimpleTradingClient {
     ...
     * @return OK
     */
    addTrade(dryRun: boolean | undefined, body: AddTradeDto, signal?: AbortSignal): Promise<SimpleTradingClientResponse<AddTradeResultDto>>;
     ...
     * @return OK
     */
    finishTrade(tradeId: string, body: FinishTradeDto, signal?: AbortSignal): Promise<SimpleTradingClientResponse<TradeResultDto>>;
...
export class SimpleTradingClient implements ISimpleTradingClient {
    ...
    protected processFinishTrade(response: Response): Promise<SimpleTradingClientResponse<TradeResultDto>> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class AddTradeDto implements IAddTradeDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.finished = _data["finished"] ? new Date(_data["finished"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["finished"] = this.finished ? this.finished.toISOString() : undefined as any;
        data["size"] = this.size;
...
export class UpdateTradeDto implements IUpdateTradeDto {
    ...
    currencyId?: string | undefined;
    entryPrice?: number | undefined;
    stopLoss?: UpdateValueOfdecimal | undefined;
    takeProfit?: UpdateValueOfdecimal | undefined;
    exitPrice?: UpdateValueOfdecimal | undefined;
    notes?: UpdateStringValue | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.currencyId = _data["currencyId"];
            this.entryPrice = _data["entryPrice"];
            this.stopLoss = _data["stopLoss"] ? UpdateValueOfdecimal.fromJS(_data["stopLoss"]) : undefined as any;
            this.takeProfit = _data["takeProfit"] ? UpdateValueOfdecimal.fromJS(_data["takeProfit"]) : undefined as any;
            this.exitPrice = _data["exitPrice"] ? UpdateValueOfdecimal.fromJS(_data["exitPrice"]) : undefined as any;
            this.notes = _data["notes"] ? UpdateStringValue.fromJS(_data["notes"]) : undefined as any;
        }
    }
...
export class UpdateValueOfdecimal implements IUpdateValueOfdecimal {
    value?: number | undefined;

    [key: string]: any;

    constructor(data?: IUpdateValueOfdecimal) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpdateValueOfdecimal {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateValueOfdecimal();
        result.init(data);
        return result;
    }
...
export interface IUpdateValueOfdecimal {
    value?: number | undefined;
