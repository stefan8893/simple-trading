...
public class TradeTests : TestBase
{
    ...
    public void You_cant_close_a_trade_before_it_was_opened()
    {
        ...
        var closeTradeDto = new Trade.FinishTradeDto(Result.Win, 500m, 1.05m, Closed, UtcNowStub, "Europe/Vienna");
    ...
    public void Already_closed_trades_cant_be_closed_again()
    {
        ...
        var closeTradeDto = new Trade.FinishTradeDto(Result.Win, 500m, 1.05m, _utcNow, UtcNowStub, Constants.DefaultTimeZone);
