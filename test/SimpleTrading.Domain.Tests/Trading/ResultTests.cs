...
public class ResultTests : TestBase
{
    ...
    public void Creating_a_result_with_a_not_supported_name_throws_an_argument_exceptions()
    {
        ...
        var act = () => new Result(notSupportedName, TradingResultSource.ManuallyEntered);
    ...
    {
        var result = new Result(nameCandidate, TradingResultSource.ManuallyEntered);
    ...
    {
        var result = new Result(name, TradingResultSource.ManuallyEntered);
