...
namespace SimpleTrading.Client
{
    ...
    public partial interface ISimpleTradingClient
    {
        ...
        /// <returns>No Content</returns>
        /// <exception cref="SimpleTradingClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task UpdateUserLanguageAsync(UpdateUserLanguageDto body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<TradeDtoPageDto> SearchTradesAsync(System.Collections.Generic.IEnumerable<string> sort = null, System.Collections.Generic.IEnumerable<string> filter = null, int? page = null, int? pageSize = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (filter != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("Filter") + "=");
                        foreach (var item_ in filter)
                        {
                            urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append(",");
                        }
                        urlBuilder_.Length--;
        ...
        /// <returns>No Content</returns>
        /// <exception cref="SimpleTradingClientException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UpdateUserLanguageAsync(UpdateUserLanguageDto body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class UpdateUserLanguageDto
    {
